...
lemma ξ_p0 : ξ p0 = (2⁻¹ : ℂ) • (-(x[0] • px[4]) + x[4] • px[0] - x[1] • px[5] + x[5] • px[1] - x[2] • px[6] + x[6] • px[2] + x[7] • px[3] - x[3] • px[7]) := by
  simp [ξ, basis, decomp, basis, decomp, p0, Finset.sum, mulVec]

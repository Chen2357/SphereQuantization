...
lemma ι_ξ_k1_α : ι (ξ k1) α = 0 := by
  simp [ξ_k1, α, ι_d]
  simp [subalgebra_smul_eq_cast_mul]
  simp only [←sub_eq_add_neg, smul_add, smul_sub]
  norm_cast
  ring_nf

lemma ι_ξ_k2_α : ι (ξ k2) α = 0 := by
  simp [ξ_k2, α, ι_d]
  simp [subalgebra_smul_eq_cast_mul]
  simp only [←sub_eq_add_neg, smul_add, smul_sub]
  norm_cast
...
lemma ι_ξ_p1_α : ι (ξ p1) α = 0 := by
  simp [ξ_p1, α, ι_d]
  simp [subalgebra_smul_eq_cast_mul]
  norm_cast
  ring_nf

lemma ι_ξ_p2_α : ι (ξ p2) α = 0 := by
  simp [ξ_p2, α, ι_d]
  simp [subalgebra_smul_eq_cast_mul]
  norm_cast
  ring_nf

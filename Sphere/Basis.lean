...
@[simp] axiom Lie03 : Lie px0 px3 = 0

@[simp] axiom Lie10 : Lie px1 px0 = 0
@[simp] lemma Lie11 : Lie px1 px1 = 0 := Lie_self px1
@[simp] axiom Lie12 : Lie px1 px2 = 0
@[simp] axiom Lie13 : Lie px1 px3 = 0

@[simp] axiom Lie20 : Lie px2 px0 = 0
@[simp] axiom Lie21 : Lie px2 px1 = 0
@[simp] lemma Lie22 : Lie px2 px2 = 0 := Lie_self px2
@[simp] axiom Lie23 : Lie px2 px3 = 0

@[simp] axiom Lie30 : Lie px3 px0 = 0
@[simp] axiom Lie31 : Lie px3 px1 = 0
@[simp] axiom Lie32 : Lie px3 px2 = 0
@[simp] lemma Lie33 : Lie px3 px3 = 0 := Lie_self px3
